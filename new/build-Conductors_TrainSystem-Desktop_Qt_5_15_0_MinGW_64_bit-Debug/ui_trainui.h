...
public:
    ...
    void setupUi(QMainWindow *trainUI)
    {
        ...
        verticalLayoutWidget_7->setGeometry(QRect(230, 90, 160, 80));
        ...
        verticalLayoutWidget_6->setGeometry(QRect(230, 189, 161, 81));
        ...
        verticalLayoutWidget_4->setGeometry(QRect(10, 0, 131, 325));
        ...
        Temp_Change->setGeometry(QRect(230, 300, 160, 22));
        ...
        verticalLayoutWidget_8->setGeometry(QRect(420, 90, 160, 193));
        verticalLayout_8 = new QVBoxLayout(verticalLayoutWidget_8);
        verticalLayout_8->setObjectName(QString::fromUtf8("verticalLayout_8"));
        verticalLayout_8->setContentsMargins(0, 0, 0, 0);
        Height = new QLabel(verticalLayoutWidget_8);
        Height->setObjectName(QString::fromUtf8("Height"));

        verticalLayout_8->addWidget(Height);

        Height_2 = new QLCDNumber(verticalLayoutWidget_8);
        Height_2->setObjectName(QString::fromUtf8("Height_2"));

        verticalLayout_8->addWidget(Height_2);

        Width = new QLabel(verticalLayoutWidget_8);
        Width->setObjectName(QString::fromUtf8("Width"));

        verticalLayout_8->addWidget(Width);

        Width_2 = new QLCDNumber(verticalLayoutWidget_8);
        Width_2->setObjectName(QString::fromUtf8("Width_2"));

        verticalLayout_8->addWidget(Width_2);

        Length = new QLabel(verticalLayoutWidget_8);
        Length->setObjectName(QString::fromUtf8("Length"));

        verticalLayout_8->addWidget(Length);

        Length_2 = new QLCDNumber(verticalLayoutWidget_8);
        Length_2->setObjectName(QString::fromUtf8("Length_2"));

        verticalLayout_8->addWidget(Length_2);
    ...
    void retranslateUi(QMainWindow *trainUI)
    {
        ...
        Height->setText(QCoreApplication::translate("trainUI", "Height (m)", nullptr));
        Width->setText(QCoreApplication::translate("trainUI", "Width (m)", nullptr));
        Length->setText(QCoreApplication::translate("trainUI", "Length (m)", nullptr));
    } // retranslateUi
