...
public:
    ...
    void setupUi(QMainWindow *HWTrainUI)
    {
        ...
        lcdNumber->setGeometry(QRect(20, 10, 101, 51));
    ...
    void retranslateUi(QMainWindow *HWTrainUI)
    {
        ...
        label_2->setText(QCoreApplication::translate("HWTrainUI", "<html><head/><body><p><span style=\" font-size:11pt;\">Train ID:</span></p></body></html>", nullptr));
    } // retranslateUi
