...
#include <memory>
#include "../../../AAA_TrainSystem/Conductors_TrainSystem/Clock.h"
...
QT_MOC_LITERAL(1, 6, 4), // "tick"
QT_MOC_LITERAL(2, 11, 0), // ""
QT_MOC_LITERAL(3, 12, 9) // "ClockTick"

    },
    "Clock\0tick\0\0ClockTick"
};
...
void Clock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Clock::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Clock::tick)) {
                *result = 0;
                return;
            }
        }
