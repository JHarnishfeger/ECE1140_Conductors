...
public:
    ...
    void setupUi(QMainWindow *UISWTrainController)
    {
        ...
        formLayoutWidget->setGeometry(QRect(20, 174, 375, 357));
        ...
        modeswitch->setSliderPosition(1);
        ...
        horizontalLayoutWidget->setGeometry(QRect(1090, 560, 146, 31));
        ...
        IDTexrLabel = new QLabel(horizontalLayoutWidget);
        IDTexrLabel->setObjectName(QString::fromUtf8("IDTexrLabel"));
        IDTexrLabel->setFont(font2);

        horizontalLayout_12->addWidget(IDTexrLabel);
        ...
        horizontalLayout_12->addWidget(IDLabel);
    ...
    void retranslateUi(QMainWindow *UISWTrainController)
    {
        ...
        IDTexrLabel->setText(QCoreApplication::translate("UISWTrainController", "Train ID", nullptr));
