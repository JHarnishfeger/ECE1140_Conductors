...
void trainMaker::newTrain(bool HardwareOrSoftware,bool GreenOrRed){
    ...
    //connect(TheTrain,SIGNAL(xferCoords(int,int,double,double)),this,SLOT(xferCoords(int,int,double,double)));
...
void trainMaker::makeNewTrain(bool HardwareOrSoftware,bool GreenOrRed){
    newTrain(HardwareOrSoftware,GreenOrRed);
}
