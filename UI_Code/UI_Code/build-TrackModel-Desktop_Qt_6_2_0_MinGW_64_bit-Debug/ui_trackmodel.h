...
public:
    ...
    void setupUi(QMainWindow *TrackModel)
    {
        ...
        selectBlockLabel = new QLabel(centralwidget);
        selectBlockLabel->setObjectName(QString::fromUtf8("selectBlockLabel"));
        selectBlockLabel->setGeometry(QRect(240, 390, 91, 21));
    ...
    void retranslateUi(QMainWindow *TrackModel)
    {
        ...
        selectBlockLabel->setText(QCoreApplication::translate("TrackModel", "Select Block:", nullptr));
