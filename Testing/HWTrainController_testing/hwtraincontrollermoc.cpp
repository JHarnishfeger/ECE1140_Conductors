...
//    qDebug() << "Authority: " << temp_authority_s;
    ...
    setCurrentSpeed_s(temp_currentSpeed_s);
    setSuggestedSpeed_s(temp_suggestedSpeed_s);
    setSpeedLimit_s(temp_speedLimit_s);
    setAuthority_s(temp_authority_s);
...
void HWTrainControllerMoc::setCurrentSpeed_s(QString CurrentSpeed)
{
    currentSpeed_s = CurrentSpeed;
}

void HWTrainControllerMoc::setSuggestedSpeed_s(QString SuggestedSpeed)
{
    suggestedSpeed_s = SuggestedSpeed;
}

void HWTrainControllerMoc::setSpeedLimit_s(QString SpeedLimit)
{
    speedLimit_s = SpeedLimit;
}

void HWTrainControllerMoc::setAuthority_s(QString Authority)
{
...
void HWTrainControllerMoc::setCurrentSpeed(double CurrentSpeed)
{
    currentSpeed = CurrentSpeed;
}

void HWTrainControllerMoc::setSuggestedSpeed(double SuggestedSpeed)
{
    suggestedSpeed = SuggestedSpeed;
}

void HWTrainControllerMoc::setSpeedLimit(double SpeedLimit)
{
    speedLimit = SpeedLimit;
}

void HWTrainControllerMoc::setAuthority(double Authority)
{
    authority = Authority;
}
